...
# ==============================================================================
# Goal G-240 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-240"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-240-creator-minor-protection-and-guardian-escrow.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g240-creator-minor-protection-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g240-creator-minor-protection-harness.mjs"
...
echo -e "${BOLD}${CYAN}    Creator Minor Protection & Legal Guardian Escrow API${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_104100_g240_creator_minor_protection_and_guardian_escrow_5why_socratic_treatise.md"
...
# Step 5: Run G-240 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit tests for G-240..."
(cd "$REPO_ROOT/code" && cargo test -p settlement-service --lib --quiet)
