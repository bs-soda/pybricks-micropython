...
# ==============================================================================
# Goal G-300 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-300"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-300-video-preflight-compliance-and-quality-scanner.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g300-video-preflight-scanner-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g300-video-preflight-scanner-harness.mjs"
...
echo -e "${BOLD}${CYAN}    Video Preflight Compliance & Quality Scanner${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_165000_g300_video_preflight_scanner_5why_socratic_treatise.md"
...
# Step 5: Run G-300 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit & integration tests for G-300..."
(cd "$REPO_ROOT/code" && cargo test -p clip-worker preflight --quiet)
(cd "$REPO_ROOT/code" && cargo test -p clip-worker --quiet)
