...
# ==============================================================================
# Goal G-285 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-285"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-285-llm-creator-persona-extractor-and-vector-fusion-engine.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g285-creator-persona-vector-fusion-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g285-creator-persona-vector-fusion-harness.mjs"
...
echo -e "${BOLD}${CYAN}    LLM Creator Persona Extractor & 768-D Multimodal Vector Fusion Engine${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_160000_g285_creator_persona_vector_fusion_5why_socratic_treatise.md"
...
# Step 5: Run G-285 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit & integration tests for G-285..."
(cd "$REPO_ROOT/code" && cargo test -p domain persona_fusion --quiet)
