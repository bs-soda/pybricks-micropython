...
# ==============================================================================
# Goal G-241 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-241"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-241-smart-dunning-and-grace-period-recovery.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g241-smart-dunning-fsm-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g241-smart-dunning-fsm-harness.mjs"
...
echo -e "${BOLD}${CYAN}    Smart Dunning FSM, Pre-Debit Reminders & Grace Period Recovery${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_104000_g241_smart_dunning_fsm_pre_debit_and_grace_period_5why_socratic_treatise.md"
...
# Step 5: Run G-241 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit tests for G-241..."
(cd "$REPO_ROOT/code" && cargo test -p payment-service --lib --quiet)
