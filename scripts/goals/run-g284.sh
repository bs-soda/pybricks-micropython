...
# ==============================================================================
# Goal G-284 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-284"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-284-multimodal-creator-data-lake-and-ml-gmv-prediction-pipeline.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g284-creator-datalake-ml-gmv-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g284-creator-datalake-ml-gmv-harness.mjs"
...
echo -e "${BOLD}${CYAN}    Multimodal Creator Raw Data Lake & ML GMV Prediction Pipeline${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_155000_g284_creator_datalake_ml_gmv_5why_socratic_treatise.md"
...
# Step 5: Run G-284 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit & integration tests for G-284..."
(cd "$REPO_ROOT/code" && cargo test -p domain datalake --quiet)
