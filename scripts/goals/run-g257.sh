...
# ==============================================================================
# Goal G-257 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-257"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-257-ai-matchmaking-and-budget-optimization.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g257-ai-matchmaking-budget-optimizer-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g257-ai-matchmaking-budget-optimizer-harness.mjs"
...
echo -e "${BOLD}${CYAN}    AI Campaign Matchmaking & Dynamic Budget Optimization Engine${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_163000_g257_ai_matchmaking_budget_optimizer_5why_socratic_treatise.md"
...
# Step 5: Run G-257 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit & integration tests for G-257..."
(cd "$REPO_ROOT/code" && cargo test -p domain matchmaking --quiet)
(cd "$REPO_ROOT/code" && cargo test -p campaign-dispatcher-service --quiet)
