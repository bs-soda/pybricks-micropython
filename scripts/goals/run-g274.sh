...
# ==============================================================================
# Goal G-274 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-274"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-274-creator-lookalike-vector-discovery-engine.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g274-creator-lookalike-vector-discovery-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g274-creator-lookalike-vector-discovery-harness.mjs"
...
echo -e "${BOLD}${CYAN}    Creator Lookalike Vector Discovery & Semantic Profile Embedding Engine${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_154000_g274_creator_lookalike_vector_discovery_5why_socratic_treatise.md"
...
# Step 5: Run G-274 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit & integration tests for G-274..."
(cd "$REPO_ROOT/code" && cargo test -p domain discovery --quiet)
