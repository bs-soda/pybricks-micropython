...
# ==============================================================================
# Goal G-272 Autonomous Socratic Runner & Zero-Mock Verification Engine
# ==============================================================================
...
GOAL_ID="G-272"
GOAL_FILE="$REPO_ROOT/docs/07-backlog/goals/G-272-halo-effect-attribution-engine.md"
SOCRATIC_ENGINE="$REPO_ROOT/scripts/agentic/g272-halo-attribution-engine-5why-socratic-engine.mjs"
HARNESS_SCRIPT="$REPO_ROOT/scripts/harness/g272-halo-attribution-engine-harness.mjs"
...
echo -e "${BOLD}${CYAN}    Halo Effect & Multi-Channel Attribution Engine${RESET}"
...
TREATISE_DOC="$REPO_ROOT/docs/06_raw/20260831_164000_g272_halo_attribution_engine_5why_socratic_treatise.md"
...
# Step 5: Run G-272 Zero-Mock Production Test Harness & Rust Backend Tests
echo -e "${BOLD}${MAGENTA}[Step 5/5] Running Zero-Mock Production Test Harness & Rust Backend Tests for ${GOAL_ID}...${RESET}"
node "$HARNESS_SCRIPT"
echo -e "  Running cargo unit & integration tests for G-272..."
(cd "$REPO_ROOT/code" && cargo test -p accounting-sync attribution --quiet)
(cd "$REPO_ROOT/code" && cargo test -p accounting-service --quiet)
